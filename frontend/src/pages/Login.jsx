...
<div className="hidden lg:flex bg-base-200 items-center justify-center">
  <div className="max-w-md text-center space-y-6 px-10">
    ...
    <p className="text-base-content/70">
      Log in to continue chatting, managing your conversations, and staying connected.
    </p>
    ...
    <div className="space-y-4 text-left">
      <div className="flex items-center gap-3">
        ...
        <span>Access your messages instantly</span>
      </div>
      ...
      <div className="flex items-center gap-3">
        ...
        <span>Continue conversations seamlessly</span>
      </div>
    </div>
